package com.cloudia.backend.CM_03_1003.constants;

public class CM031003MessageConstant {
    private CM031003MessageConstant() {
    }
    // 商品取得
    ...
    // 成功・失敗メッセージ
    public static final String SUCCESS_PRODUCT_FIND = "商品取得に成功しました。";
    public static final String SUCCESS_PRODUCT_UPLOAD = "商品登録に成功しました。";
    public static final String SUCCESS_PRODUCT_UPDATE = "商品更新に成功しました。";
    public static final String SUCCESS_PRODUCT_DELETE = "商品削除に成功しました。";
    ...
    public static final String FAIL_PRODUCT_DUPLICATE_NAME = "既に同名の商品が存在します。";
    public static final String FAIL_PRODUCT_VALIDATION = "商品登録の検証に失敗しました: {}";
    ...
    public static final String FAIL_CART_ADD = "カート追加に失敗しました: エラーが発生しました。";
    public static final String FAIL_CART_UPDATE = "カート数量更新に失敗しました: エラーが発生しました。";
    ...
    public static final String FAIL_BANNER_VAL = "バナー登録の検証に失敗しました: {}";
