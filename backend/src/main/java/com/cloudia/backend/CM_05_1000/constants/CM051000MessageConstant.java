...
public class CM051000MessageConstant {
    ...
    // お知らせ取得関連
    public static final String NOTICE_FIND_ALL_START = "お知らせ一覧の取得を開始";
    public static final String NOTICE_FIND_ALL_COMPLETE = "お知らせ一覧の取得が完了しました。取得件数: {}";
    public static final String NOTICE_FIND_ALL_DB_ERROR = "お知らせ一覧の取得中にDBエラーが発生しました: {}";
    public static final String NOTICE_FIND_ALL_UNEXPECTED_ERROR = "お知らせ一覧の取得中に予期しないエラーが発生しました: {}";
    ...
    public static final String NOTICE_FIND_BY_ID_START = "お知らせ詳細の取得を開始。お知らせID: {}";
    public static final String NOTICE_FIND_BY_ID_COMPLETE = "お知らせ詳細の取得が完了しました。お知らせID: {}, 取得件数: {}";
    public static final String NOTICE_FIND_BY_ID_FAILED_INVALID_ID = "お知らせ詳細の取得に失敗しました: 無効なお知らせIDです。お知らせID: {}";
    public static final String NOTICE_FIND_BY_ID_DB_ERROR = "お知らせ詳細の取得中にDBエラーが発生しました。お知らせID: {}, エラー: {}";
    public static final String NOTICE_FIND_BY_ID_UNEXPECTED_ERROR = "お知らせ詳細の取得中に予期しないエラーが発生しました。お知らせID: {}, エラー: {}";

    // お知らせ閲覧数関連
    public static final String NOTICE_VIEW_INCREMENT_SUCCESS = "お知らせの閲覧数増加に成功しました";
    public static final String NOTICE_VIEW_INCREMENT_FAIL = "お知らせの閲覧数増加に失敗しました";
    public static final String NOTICE_VIEW_INCREMENT_ERROR = "お知らせの閲覧数増加中にエラーが発生しました";
    public static final String NOTICE_VIEW_ALREADY_COUNTED = "本日はすでに閲覧数が反映されています。key={}";
    ...
    // お知らせ削除関連
    public static final String NOTICE_DELETE_START = "お知らせ削除を開始。お知らせID: {}";
    public static final String NOTICE_DELETE_COMPLETE = "お知らせ削除が完了しました。お知らせID: {}, 削除結果: {}";
    public static final String NOTICE_DELETE_FAILED_INVALID_ID = "お知らせ削除に失敗しました: 無効なお知らせIDです。お知らせID: {}";
    public static final String NOTICE_DELETE_FAILED_NOT_EXISTS = "お知らせ削除に失敗しました: 存在しないお知らせです。お知らせID: {}";
    public static final String NOTICE_DELETE_DB_ERROR = "お知らせ削除中にDBエラーが発生しました。お知らせID: {}, エラー: {}";
    public static final String NOTICE_DELETE_UNEXPECTED_ERROR = "お知らせ削除中に予期しないエラーが発生しました。お知らせID: {}, エラー: {}";

    public static final String SUCCESS_NOTICE_DELETE = "お知らせの削除に成功しました";
}